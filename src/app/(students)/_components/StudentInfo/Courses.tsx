                                    ...
                                    .map((assignment, index) => (
                                        <div className="assignmentGridConSP w-[30%]" key={`classAssignment${index}`}>
                                            <div className={`assignmentConSP p-2 rounded-lg ${assignment.type}`}>
                                                ...
                                                <h4 className="assignDueDateSP text-sm text-zinc-500 mb-2">Due Date: {assignment.dueDate?.toLocaleDateString()}</h4>
                                                <h4 className={`assignGradeSP text-md font-bold`}>Grade: {assignment.grade} ({calcLetterGrade(assignment.grade ?? 'N/A')})</h4>
                                            </div>
                                        </div>
                                    ))}
                            </div>
