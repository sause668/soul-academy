    ...
    return (
        <div id="profileConDB" className="whiteBox flex md:flex-col justify-center items-center gap-2 p-2">
            ...
            <div id="profileInfoConDB">
                <h3 className="profileInfoDB font-subtitle text-2xl font-bold">{student.firstName} {student.lastName}</h3>
                <h4 className="profileInfoDB font-subtitle text-lg">Student</h4>
                <h4 className="profileInfoDB font-body text-zinc-500">{student.currentGrade}th Grade</h4>
